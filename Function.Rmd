...
Bayes_function <- function(mutation, process, sample, nmf_matrix, mutation_matrix){
  #Pr(Mutation|Signature)
  a <- nmf_matrix$signatures[mutation,process]/sum(nmf_matrix$signatures[,process])
  #Pr(Signature)
  b <- nmf_matrix$contribution[process,sample]/sum(nmf_matrix$contribution[,sample])
  #Pr(Mutation)
