...
ggplot(data = sens.spec.data.2, aes(x = cosine_similarity, y = value, color = measure))+
  geom_point()+
  geom_smooth(method = lm)+
  labs(title = "Sensitivity & Specificity vs. Cosine Similarity to FFPE Signature", x = "Cosine Similarity of COSMIC Signature to FFPE", y = "Sensitivity and Specificity")
```
